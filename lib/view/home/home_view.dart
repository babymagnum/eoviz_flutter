      ...
      tabBar: CupertinoTabBar(
        ...
        items: [
          BottomNavigationBarItem(
            ...
            title: Text(buildTranslate(context, 'home'), style: ThemeTextStyle.poppinsLight.apply(color: Color(_selectedIndex == 0 ? 0xFF347eb2 : 0xFF253644), fontSizeDelta: size.width * 0.027)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.assignment_turned_in, size: size.width * 0.045, color: _selectedIndex == 1 ? Color(0xFF347eb2) : Color(0xFF253644)),
            title: Text(buildTranslate(context, 'approval'), style: ThemeTextStyle.poppinsLight.apply(color: Color(_selectedIndex == 1 ? 0xFF347eb2 : 0xFF253644), fontSizeDelta: size.width * 0.027)),
          ),
          BottomNavigationBarItem(
            ...
            title: Text(buildTranslate(context, 'notification'), style: ThemeTextStyle.poppinsLight.apply(color: Color(_selectedIndex == 2 ? 0xFF347eb2 : 0xFF253644), fontSizeDelta: size.width * 0.027)),
          ),
          BottomNavigationBarItem(
            ...
            title: Text(buildTranslate(context, 'profile'), style: ThemeTextStyle.poppinsLight.apply(color: Color(_selectedIndex == 3 ? 0xFF347eb2 : 0xFF253644), fontSizeDelta: size.width * 0.027)),
          ),
        ]
      ),
